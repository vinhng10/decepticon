...
if __name__ == "__main__":
    ...
    # fx_dm.setup()
    fx_infer = RaceModule.load_from_checkpoint("models/ckpts/transformer_que.ckpt")
    fx_infer.eval()
    ...
    fx_infer = RaceModule.load_from_checkpoint("models/ckpts/transformer_dis.ckpt")
    fx_infer.eval()
    print("ANS", answer)
    # print("QUE", questions)
    print("DIS", fx_infer.generate_distractor(article, answer, "The passage suggests that students _.", pred_len=20))
