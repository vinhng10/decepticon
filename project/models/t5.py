...
class T5FinetuneForRACE(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        decay =  lambda epoch: 0.95 ** epoch
        scheduler = torch.optim.lr_scheduler.LambdaLR(optimizer, [decay, decay])
        
        #scheduler = torch.optim.lr_scheduler.StepLR(optimizer, gamma=0.05)
        #scheduler = LinearWarmupCosineAnnealingLR(optimizer, warmup_epochs=2, max_epochs=20)
